...
class M_katalog extends CI_Model {
	public function select_all_katalog() {
	...
	public function select_all() {
		$sql = " SELECT katalog.id AS id, katalog.nm_data AS nm_data, ref_schema.nm_schema as nm_skema,ref_skema.nm_tabel AS nm_tabel, katalog.keterangan AS keterangan FROM katalog left join ref_skema on katalog.id_skema = ref_skema.id_skema left join ref_schema on katalog.id_schema=ref_schema.id"  ;
	...
	public function insert($data) {
		...
		$sql = "INSERT INTO katalog VALUES('','" .strtoupper($data['schema']) ."','" .strtoupper($data['nm_data']) ."','" .$data['jenis'] ."','" .ucfirst($data['keterangan']) ."')";

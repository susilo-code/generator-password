...
class M_data extends CI_Model {
	...
	public function select_by_id($id) {
		$sql = "SELECT * FROM ref_data WHERE id_data = '{$id}'";
	...
	public function select_by_data($id) {
	...
	public function insert($data) {
		$sql = "INSERT INTO ref_data VALUES('','" .$data['ktgr'] ."','" .$data['jenis'] ."')";
...
public function insertskema($data) {
		$sql = "INSERT INTO ref_skema VALUES('','" .$data['dbase'] ."','" .strtoupper($data['skema'])."')";
	...
	public function delete($id) {
		$sql = "DELETE FROM ref_data WHERE id_data='" .$id ."'";
